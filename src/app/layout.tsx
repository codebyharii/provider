        ...
        <header className="bg-white border-b border-soft sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <nav className="flex items-center gap-6 text-sm font-medium">
              <a href="/request-service" className="text-muted hover:text-primary transition-colors">Request Service</a>
              <a href="/dashboard" className="text-muted hover:text-primary transition-colors">Dashboard</a>
              <a href="/test-tools" className="text-muted hover:text-primary transition-colors">Test Tools</a>
            </nav>
          </div>
        </header>
